...
export const AppFileUploader: React.FC<FileUploaderProps> = ({
  ...
  return (
    <div
      className={`border-2 border-dashed border-light-gray7 rounded-lg p-4 flex flex-col items-center justify-center transition-colors
        ${isDragging || isHovering ? 'border-light-blue12 bg-blue-50' : 'border-gray-300'}
