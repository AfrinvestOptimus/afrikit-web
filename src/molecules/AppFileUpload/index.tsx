...
export const AppFileUploader: React.FC<FileUploaderProps> = ({
  ...
  onUpload,
  width = '100%',
  height = 'auto', // Change height to auto to accommodate the image's natural size
}) => {
  ...
  return (
    <div className="max-w-md mx-auto">
      <div
        className={`border-2 border-dashed border-light-gray8 rounded-lg p-4 flex flex-col items-center justify-center ${
      ...
      >
        {uploadedImageUrl ? (
          ...
          <img
            src={`${uploadedImageUrl || "images/jpg/avatar1.jpeg"}`}
            alt="Uploaded file"
          ...
          <div className="flex flex-col items-center">
            <i className="ri-file-line text-gray-500 text-2xl mb-2" />
            <span className="text-sm truncate">{file.name}</span>
            {isUploading && (
              <div className="w-full mt-2">
                <div
                  className="bg-light-blue8 h-1"
          ...
          <>
            <i className="ri-file-line text-4xl mb-2" />
            <p className="text-sm text-center">
              <span className="text-light-blue10 font-semibold text-sm">
                Click to upload{' '}
              </span>
              or drag and drop
            </p>
            <p className="text-sm text-light-gray10 text-center">
