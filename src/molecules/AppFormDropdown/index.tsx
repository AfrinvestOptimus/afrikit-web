    ...
    <div className="relative w-full" ref={dropdownRef}>
      ...
      <div
        ...
        <div className="pl-sm">
          <i
            className={clsx(
              'ri-arrow-down-s-line transform text-xl text-light-type-gray-muted transition-transform dark:text-dark-type-gray-muted',
      ...
      {showDropdown && (
        <div
          className="left-0 right-0 rounded fixed rounded-sm bg-white shadow-lg"
          style={{
            position: 'absolute',
            zIndex: 1000,
            maxHeight: '300px',
          ...
          {/* Search bar */}
          <div className="top-0 sticky z-10 border-b border-light-neutral4 bg-white dark:border-dark-neutral4">
            <div className="px-3 py-2 flex items-center space-x-md">
              ...
              <input
                ...
                className="bg-transparent placeholder-gray-400 w-full border-none text-light-type-gray outline-none dark:text-dark-type-gray dark:placeholder-dark-type-gray-muted"
              />
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-black">
            {filteredItems.length > 0 ? (
              filteredItems.map((item, index) => (
                <div
                  key={`${item?.name}-${index}`}
                  className="px-4 hover:bg-gray-100 flex cursor-pointer items-center justify-between px-md py-sm transition-all duration-300 ease-in-out dark:hover:bg-dark-background-neutral-transparent-hover"
